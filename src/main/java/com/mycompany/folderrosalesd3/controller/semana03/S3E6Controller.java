                ...
                <details class="group bg-[#111] rounded-lg border border-[#222] transition-all duration-300 open:border-[var(--dorado)]">
                    ...
                    <div class="p-6 border-t border-[#222] space-y-6">
                        <div class="bg-amber-950/20 border-l-4 border-[var(--dorado)] p-4 rounded-r-lg">
                            <h4 class="text-xs font-mono text-[var(--dorado)] font-bold uppercase mb-1">Aportaciones de Ley Desacopladas</h4>
                            <p class="text-[11px] text-gray-300 font-mono leading-relaxed">
                                Las retenciones de AFP y ESSALUD se segmentan en métodos independientes en el modelo para facilitar la extensibilidad. Si las tasas porcentuales varían en el futuro, solo se requiere modificar un único punto en la capa lógica.
                            </p>
                        </div>
                    </div>
                </details>
