            ...
            <details class="group bg-[#111] rounded-lg border border-[#222] transition-all duration-300 open:border-[var(--dorado)]">
                ...
                <div class="p-6 border-t border-[#222] space-y-6">
                    ...
                    <div class="bg-amber-950/20 border-l-4 border-[var(--dorado)] p-4 rounded-r-lg">
                        <h4 class="text-xs font-mono text-[var(--dorado)] font-bold uppercase mb-1">Distribución Porcentual Exacta</h4>
                        <p class="text-[11px] text-gray-300 font-mono leading-relaxed">
                            Los cálculos se realizan de forma aislada en el Modelo matemático multiplicando el presupuesto de entrada por factores decimales exactos que suman $1.00$ ($100\%$), garantizando que la suma total coincida al centavo.
                        </p>
                    </div>
    ...
    return this.montoInvertir * 0.23;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Aplica la tasa fija del $23\%$ sobre el presupuesto total de inversión asignada por la empresa.
                                </p>
                            </div>
                        </div>
