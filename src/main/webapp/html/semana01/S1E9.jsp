            ...
            <details class="group bg-[#111] rounded-lg border border-[#222] transition-all duration-300 open:border-[var(--dorado)]">
                ...
                <div class="p-6 border-t border-[#222] space-y-6">
                    ...
                    <div class="bg-amber-950/20 border-l-4 border-[var(--dorado)] p-4 rounded-r-lg">
                        <h4 class="text-xs font-mono text-[var(--dorado)] font-bold uppercase mb-1">Cadenas de Dependencias en Cascada</h4>
                        <p class="text-[11px] text-gray-300 font-mono leading-relaxed">
                            Debido a que ciertos montos dependen de los valores intermedios asignados a otros hijos (por ejemplo, Tamar depende de Josué, y Caleb de Josué y Daniel), las funciones se llaman entre sí dentro del propio modelo garantizando integridad referencial limpia.
                        </p>
                    </div>
            ...
            calcularDaniel()) * 0.23;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Utiliza los métodos internos del propio modelo para resolver la dependencia porcentual del 23% sobre la suma asignada a sus dos hermanos.
                                </p>
                            </div>
                        </div>
