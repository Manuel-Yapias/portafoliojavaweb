                ...
                <details class="group bg-[#111] rounded-lg border border-[#222] transition-all duration-300 open:border-[var(--dorado)]">
                    ...
                    <div class="p-6 border-t border-[#222] space-y-6">
                        ...
                        <div class="bg-amber-950/20 border-l-4 border-[var(--dorado)] p-4 rounded-r-lg">
                            <h4 class="text-xs font-mono text-[var(--dorado)] font-bold uppercase mb-1">Estructura Desacoplada de Operaciones</h4>
                            <p class="text-[11px] text-gray-300 font-mono leading-relaxed">
                                Mantenemos un flujo ordenado donde la extracción, la inyección y el procesamiento matemático se ejecutan bajo funciones estrictamente individuales.
                            </p>
                        </div>
            ...
            * altura) / 2.0;
                                ...
                                <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                    ...
                                    <p class="text-gray-400 leading-relaxed">
                                        Lógica de negocio encapsulada que procesa la ecuación descrita de manera limpia y devuelve el valor de superficie resultante.
                                    </p>
                                </div>
                            </div>
