            ...
            <details class="group bg-[#111] rounded-lg border border-[#222] transition-all duration-300 open:border-[var(--dorado)]">
                ...
                <div class="p-6 border-t border-[#222] space-y-6">
                    ...
                    <div class="bg-amber-950/20 border-l-4 border-[var(--dorado)] p-4 rounded-r-lg">
                        <h4 class="text-xs font-mono text-[var(--dorado)] font-bold uppercase mb-1">Ecuaciones Geométricas del Cubo</h4>
                        <p class="text-[11px] text-gray-300 font-mono leading-relaxed">
                            Los cálculos matemáticos tridimensionales están completamente desacoplados del controlador para mantener un flujo limpio y una arquitectura modular sólida.
                        </p>
                    </div>
    ...
    return 6 * Math.pow(this.lado, 2);
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Multiplica por seis el área de una cara cuadrada para obtener la superficie exterior total del hexaedro regular.
                                </p>
                            </div>
                        </div>
...
<pre><code>public double calcularVolumen() {
    return Math.pow(this.lado, 3);
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Eleva la longitud de la arista (lado) al cubo para computar el espacio tridimensional encerrado por el cuerpo.
                                </p>
                            </div>
                        </div>
