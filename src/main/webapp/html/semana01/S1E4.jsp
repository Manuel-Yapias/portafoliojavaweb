            ...
            <details class="group bg-[#111] rounded-lg border border-[#222] transition-all duration-300 open:border-[var(--dorado)]">
                ...
                <div class="p-6 border-t border-[#222] space-y-6">
                    ...
                    <div class="bg-amber-950/20 border-l-4 border-[var(--dorado)] p-4 rounded-r-lg">
                        <h4 class="text-xs font-mono text-[var(--dorado)] font-bold uppercase mb-1">Cálculo Tridimensional Encapsulado</h4>
                        <p class="text-[11px] text-gray-300 font-mono leading-relaxed">
                            Procesamos las ecuaciones volumétricas y de superficie del cilindro de forma aislada para garantizar la escalabilidad y limpieza del código.
                        </p>
                    </div>
           ...
           * (radio + altura);
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Aplica la fórmula matemática para obtener la superficie exterior total sumando las dos bases circulares y la cara lateral.
                                </p>
                            </div>
                        </div>
    ...
    return Math.PI * Math.pow(radio, 2) 
           * altura;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Calcula la capacidad de almacenamiento cilíndrico multiplicando el área de la base circular por la altura.
                                </p>
                            </div>
                        </div>
