...
<html lang="es">
                ...
                <details class="group bg-[#111] rounded-lg border border-[#222] transition-all duration-300 open:border-[var(--dorado)]">
                    ...
                    <div class="p-6 border-t border-[#222] space-y-6">
                        ...
                        <div class="bg-amber-950/20 border-l-4 border-[var(--dorado)] p-4 rounded-r-lg">
                            <h4 class="text-xs font-mono text-[var(--dorado)] font-bold uppercase mb-1">Cálculo de Descuentos en Cadena</h4>
                            <p class="text-[11px] text-gray-300 font-mono leading-relaxed">
                                El cálculo del descuento sucesivo <span class="text-[var(--dorado)] font-bold">7% + 7%</span> no equivale a un 14% directo. La modularización del modelo permite obtener primero el descuento primario y restar ese valor de forma interna antes de calcular el segundo descuento.
                            </p>
                        </div>
    ...
    double saldoRestante = calcularImporteCompra() 
    ...
    return saldoRestante * 0.07;
                                ...
                                <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                    ...
                                    <p class="text-gray-400 leading-relaxed">
                                        Calcula el segundo recorte aplicando el <span class="text-[var(--dorado)]">7%</span> sobre el saldo provisional restante una vez deducida la primera bonificación.
                                    </p>
                                </div>
                            </div>
    ...
    request.setAttribute("importePagar", 
        modelo.calcularImportePagar());
                                ...
                                <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                    ...
                                    <p class="text-gray-400 leading-relaxed">
                                        Asigna de manera atómica todos los componentes de la cadena de descuentos al contexto del request para su consumo síncrono.
                                    </p>
                                </div>
                            </div>
                        </div>
