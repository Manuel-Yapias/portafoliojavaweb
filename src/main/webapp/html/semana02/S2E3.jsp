                ...
                <details class="group bg-[#111] rounded-lg border border-[#222] transition-all duration-300 open:border-[var(--dorado)]">
                    ...
                    <div class="p-6 border-t border-[#222] space-y-6">
                        ...
                        <div class="bg-amber-950/20 border-l-4 border-[var(--dorado)] p-4 rounded-r-lg">
                            <h4 class="text-xs font-mono text-[var(--dorado)] font-bold uppercase mb-1">Encapsulamiento y Secuencia de Planillas</h4>
                            <p class="text-[11px] text-gray-300 font-mono leading-relaxed">
                                El proceso calcula de forma escalonada el sueldo básico, la bonificación asociada, el bruto acumulado, el descuento de ley y finalmente el neto. Todo esto bajo la lógica exclusiva del Modelo.
                            </p>
                        </div>
        ...
        + calcularBonificacion();
                                ...
                                <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                    ...
                                    <p class="text-gray-400 leading-relaxed">
                                        Suma de manera atómica el sueldo base calculado previamente con el 20% asignado a su bonificación de ley.
                                    </p>
                                </div>
                            </div>
    ...
    request.setAttribute("sueldoNeto", 
        modelo.calcularSueldoNeto());
                                ...
                                <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                    ...
                                    <p class="text-gray-400 leading-relaxed">
                                        Coloca ordenadamente todos los elementos calculados de la boleta de pago dentro del request scope para su pintado inmediato.
                                    </p>
                                </div>
                            </div>
                        </div>
