                ...
                <details class="group bg-[#111] rounded-lg border border-[#222] transition-all duration-300 open:border-[var(--dorado)]">
                    ...
                    <div class="p-6 border-t border-[#222] space-y-6">
                        ...
                        <div class="bg-amber-950/20 border-l-4 border-[var(--dorado)] p-4 rounded-r-lg">
                            <h4 class="text-xs font-mono text-[var(--dorado)] font-bold uppercase mb-1">Cálculos Salariales Desacoplados</h4>
                            <p class="text-[11px] text-gray-300 font-mono leading-relaxed">
                                Este modelo encapsula por separado cada tipo de deducción de planilla de acuerdo al marco normativo vigente, permitiendo agregar o modificar aportes fiscales futuros sin comprometer la vista ni alterar el flujo principal de los controladores.
                            </p>
                        </div>
         ...
         + calcularDescuentoAfp();
                                ...
                                <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                    ...
                                    <p class="text-gray-400 leading-relaxed">
                                        Consolida el descuento acumulando las salidas asociadas a pensiones y salud estatal de manera sumatoria.
                                    </p>
                                </div>
                            </div>
    ...
    request.setAttribute("sueldoNeto", 
        modelo.calcularSueldoNeto());
                                ...
                                <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                    ...
                                    <p class="text-gray-400 leading-relaxed">
                                        Empaqueta la totalidad de los descuentos independientes y el sueldo bruto/neto en el request context para su procesamiento de lado de la vista.
                                    </p>
                                </div>
                            </div>
                        </div>
