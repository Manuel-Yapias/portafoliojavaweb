                ...
                <details class="group bg-[#111] rounded-lg border border-[#222] transition-all duration-300 open:border-[var(--dorado)]">
                    ...
                    <div class="p-6 border-t border-[#222] space-y-6">
                        ...
                        <div class="bg-amber-950/20 border-l-4 border-[var(--dorado)] p-4 rounded-r-lg">
                            <h4 class="text-xs font-mono text-[var(--dorado)] font-bold uppercase mb-1">Uso de Constantes Fijas en Programación</h4>
                            <p class="text-[11px] text-gray-300 font-mono leading-relaxed">
                                En este ejercicio el sueldo básico se define como una constante estática inmutable (`static final`) dentro de la lógica del Modelo. El resto de las operaciones derivan del flujo dinámico inyectado desde el Servlet.
                            </p>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
                                <div class="lg:col-span-5 bg-black p-3 rounded font-mono text-[10px] text-[var(--dorado)] overflow-x-auto border-l-2 border-[var(--dorado)]">
                                    <pre><code>private static final double 
    SUELDO_BASICO_CONSTANTE = 300.0;
    ...
    return SUELDO_BASICO_CONSTANTE;
                                ...
                                <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                    ...
                                    <p class="text-gray-400 leading-relaxed">
                                        Retorna de manera centralizada la constante asignada por las reglas de la empresa para evitar colocar "números mágicos" hardcodeados en los cálculos.
                                    </p>
                                </div>
                            </div>
    ...
    request.setAttribute("sueldoNeto", 
        modelo.calcularSueldoNeto());
                                ...
                                <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                    ...
                                    <p class="text-gray-400 leading-relaxed">
                                        Intermedia entre el modelo y la vista, guardando los cálculos necesarios dentro del contexto de la petición (`request scope`).
                                    </p>
                                </div>
                            </div>
                        </div>
