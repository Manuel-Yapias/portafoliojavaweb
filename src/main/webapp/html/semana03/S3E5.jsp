                ...
                <details class="group bg-[#111] rounded-lg border border-[#222] transition-all duration-300 open:border-[var(--dorado)]">
                    ...
                    <div class="p-6 border-t border-[#222] space-y-6">
                        <div class="bg-amber-950/20 border-l-4 border-[var(--dorado)] p-4 rounded-r-lg">
                            <h4 class="text-xs font-mono text-[var(--dorado)] font-bold uppercase mb-1">Estructura del Sueldo Fijo</h4>
                            <p class="text-[11px] text-gray-300 font-mono leading-relaxed">
                                El sueldo básico se encuentra predefinido como una constante estática de S/.300 en el modelo. Toda alteración a la lógica de comisiones se procesa de forma dinámica en base al importe declarado.
                            </p>
                        </div>
                    </div>
                </details>
