...
<html lang="es">
        ...
        "/html/semana01/S1E7.jsp"
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">función exclusiva</span> de delegar el flujo de ejecución reenviando la petición hacia la plantilla JSP del Ejercicio 7.
                                </p>
                            </div>
                        </div>

                        <!-- Método 2: obtenerInverso() -->
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
    ...
    String cadenaOriginal = String.format(
        "%05d", this.numero
    );
    return new StringBuilder(cadenaOriginal)
        ...
        .toString();
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">única responsabilidad</span> de formatear el número garantizando exactamente 5 dígitos con ceros a la izquierda y revertir su cadena mediante StringBuilder.
                                </p>
                            </div>
                        </div>
