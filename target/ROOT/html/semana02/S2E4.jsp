...
<html lang="es">
        ...
        modelo.calcularTraumatologia()
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Encargado <span class="text-[var(--dorado)]">únicamente</span> de publicar en el Request Scope los montos asignados a cada especialidad: Medicina General, Ginecología, Pediatría y Traumatología.
                                </p>
                            </div>
                        </div>
    ...
    request.getRequestDispatcher(
        "/html/semana02/S2E4.jsp"
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">función exclusiva</span> de delegar el flujo de la petición hacia la vista JSP correspondiente al Ejercicio 4 de la Semana 2.
                                </p>
                            </div>
                        </div>

                        <!-- Método 3: calcularMedicinaGeneral() -->
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
                            <div class="lg:col-span-5 bg-black p-3 rounded font-mono text-[10px] text-[var(--dorado)] overflow-x-auto border-l-2 border-[var(--dorado)]">
                                <pre><code>public double calcularMedicinaGeneral() {
    return this.donacionTotal * 0.45;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <h5 class="text-white font-bold mb-2 text-sm">Método: calcularMedicinaGeneral()</h5>
                                <p class="text-gray-400 leading-relaxed">
                                    Calcula con <span class="text-[var(--dorado)]">responsabilidad única</span> la partida presupuestal asignada a Medicina General correspondiente al **45%** de la donación total.
                                </p>
                            </div>
                        </div>

                        <!-- Método 4: calcularGinecologia() -->
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
                            <div class="lg:col-span-5 bg-black p-3 rounded font-mono text-[10px] text-[var(--dorado)] overflow-x-auto border-l-2 border-[var(--dorado)]">
                                <pre><code>public double calcularGinecologia() {
    return calcularMedicinaGeneral() * 0.80;
}</code></pre>
                            </div>
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                <span class="text-[10px] text-[var(--dorado)] tracking-wider mb-1 uppercase font-bold">🧮 MODELO // NEGOCIO</span>
                                <h5 class="text-white font-bold mb-2 text-sm">Método: calcularGinecologia()</h5>
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">única tarea</span> de calcular el fondo para Ginecología, equivalente al **80%** del monto asignado a Medicina General.
                                </p>
                            </div>
                        </div>

                        <!-- Método 5: calcularPediatria() -->
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
                            <div class="lg:col-span-5 bg-black p-3 rounded font-mono text-[10px] text-[var(--dorado)] overflow-x-auto border-l-2 border-[var(--dorado)]">
                                <pre><code>public double calcularPediatria() {
    double subtotal = 
        calcularMedicinaGeneral() 
        + calcularGinecologia();
    return subtotal * 0.20;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Determina el presupuesto de Pediatría calculando el **20%** de la suma acumulada de Medicina General y Ginecología, manteniendo su <span class="text-[var(--dorado)]">responsabilidad exclusiva</span>.
                                </p>
                            </div>
                        </div>

                        <!-- Método 6: calcularTraumatologia() -->
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
                            <div class="lg:col-span-5 bg-black p-3 rounded font-mono text-[10px] text-[var(--dorado)] overflow-x-auto border-l-2 border-[var(--dorado)]">
                                <pre><code>public double calcularTraumatologia() {
    double asignado = 
        calcularMedicinaGeneral() 
        + calcularGinecologia() 
        + calcularPediatria();
    return this.donacionTotal - asignado;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                <span class="text-[10px] text-[var(--dorado)] tracking-wider mb-1 uppercase font-bold">🧮 MODELO // NEGOCIO</span>
                                <h5 class="text-white font-bold mb-2 text-sm">Método: calcularTraumatologia()</h5>
                                <p class="text-gray-400 leading-relaxed">
                                    Se encarga <span class="text-[var(--dorado)]">únicamente</span> de obtener el remanente presupuestal restando las asignaciones previas al total de la donación recibida.
                                </p>
                            </div>
                        </div>
