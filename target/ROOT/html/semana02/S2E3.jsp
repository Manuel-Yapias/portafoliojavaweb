...
<html lang="es">
    <head>
        ...
        <title>S2E3 - Cálculo de Pago Mensual</title>
    ...
    <body class="min-h-screen flex flex-col p-4 md:p-6 justify-between">
        ...
        <header class="w-full max-w-[900px] mx-auto flex items-center justify-between py-5 px-6 bg-[#0d0d0d] border border-[#1c1c1c] rounded-t-lg">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-[var(--dorado)] tracking-widest font-mono uppercase">Semana 2 - Ejercicio 3</p>
                </div>
            </div>
        ...
        <main class="w-full max-w-[900px] mx-auto bg-[#0d0d0d] border-x border-[#1c1c1c] p-6 md:p-8 space-y-8">
            ...
            <div class="bg-[#111] p-4 rounded-lg border border-[#222]">
                <h2 class="text-xs font-mono text-[var(--dorado)] uppercase tracking-wider mb-2">📋 Enunciado del Ejercicio (Planilla Mensual)</h2>
                <p class="text-sm text-gray-300 leading-relaxed">
                    Diseñe un programa que determine el <strong>sueldo básico</strong> (Horas Trabajadas &times; Tarifa), una <strong>bonificación del 20%</strong>, el <strong>sueldo bruto</strong>, un <strong>descuento del 10%</strong> sobre el sueldo bruto y el <strong>sueldo neto</strong> final asignado al trabajador.
                </p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">

                <form action="${pageContext.request.contextPath}/S2E3Controller" method="POST" class="space-y-4">
                    <h3 class="text-sm font-mono text-white uppercase tracking-widest border-b border-[#222] pb-2">🎰 Parámetros Laborales</h3>

                    <div>
                        <label for="horas" class="block text-xs font-mono text-gray-400 mb-1">Horas Trabajadas en el Mes:</label>
                    ...
                    <div>
                        <label for="tarifa" class="block text-xs font-mono text-gray-400 mb-1">Tarifa por Hora de Trabajo (S/.):</label>
                ...
                <div class="bg-[#121212] border border-[#222] rounded-lg p-6 flex flex-col justify-between">
                    <div>
                        <h3 class="text-sm font-mono text-white uppercase tracking-widest border-b border-[#222] pb-2 mb-4">🏆 Boleta de Pagos</h3>
                        ...
                        <div class="space-y-3 font-mono">
                            ...
                            <div class="flex justify-between items-center py-2 border-b border-[#1c1c1c]">
                                <span class="text-xs text-gray-300">Sueldo Básico:</span>
                            ...
                            <div class="flex justify-between items-center py-2 border-b border-[#1c1c1c] text-red-400">
                                <span class="text-xs">Descuento (10%):</span>
                                <span class="text-sm">- S/. ${descuento}</span>
                            </div>
                            <div class="flex justify-between items-center py-2 pt-4">
                                <span class="text-xs text-[var(--dorado)] font-bold">Sueldo Neto a Pagar:</span>
                                <span class="text-lg font-bold text-[var(--dorado)]">S/. ${sueldoNeto}</span>
                            </div>
                        </div>
                        <% } else { %>
                        <p class="text-xs text-gray-500 font-mono italic text-center py-12">Ingrese las horas trabajadas y la tarifa para generar los montos calculados por el sistema.</p>
                        <% }%>
                    </div>
                </div>
            </div>
                ...
                <details class="group bg-[#111] rounded-lg border border-[#222] transition-all duration-300 open:border-[var(--dorado)]">
                    <summary class="flex justify-between items-center p-4 cursor-pointer select-none hover:bg-[#161616] transition-colors rounded-lg">
                        <span class="text-xs font-mono text-[var(--dorado)] uppercase tracking-widest flex items-center gap-2">
                            <span>📖</span> MANUAL DE USO Y EXPLICACIÓN DE MÉTODOS (S2E3 - MVC)
                        </span>
    ...
    request.setAttribute("sueldoBasico", 
        modelo.calcularSueldoBasico()
    );
    request.setAttribute("bonificacion", 
        modelo.calcularBonificacion()
    );
        ...
        modelo.calcularSueldoNeto()
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Encargado <span class="text-[var(--dorado)]">únicamente</span> de transferir al Request Scope las variables procesadas de la nómina: sueldo básico, bonificación, sueldo bruto, descuento y sueldo neto.
                                </p>
                            </div>
                        </div>
    ...
    request.getRequestDispatcher(
        "/html/semana02/S2E3.jsp"
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">función exclusiva</span> de reenviar el flujo de procesamiento hacia la vista JSP correspondiente al Ejercicio 3 de la Semana 2.
                                </p>
                            </div>
                        </div>

                        <!-- Método 3: calcularSueldoBasico() -->
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
                            <div class="lg:col-span-5 bg-black p-3 rounded font-mono text-[10px] text-[var(--dorado)] overflow-x-auto border-l-2 border-[var(--dorado)]">
                                <pre><code>public double calcularSueldoBasico() {
    return this.horasTrabajadas * this.tarifaHoraria;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <h5 class="text-white font-bold mb-2 text-sm">Método: calcularSueldoBasico()</h5>
                                <p class="text-gray-400 leading-relaxed">
                                    Calcula con <span class="text-[var(--dorado)]">responsabilidad única</span> el pago base multiplicando las horas laboradas por la tarifa por hora asignada.
                                </p>
                            </div>
                        </div>

                        <!-- Método 4: calcularBonificacion() -->
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
                            <div class="lg:col-span-5 bg-black p-3 rounded font-mono text-[10px] text-[var(--dorado)] overflow-x-auto border-l-2 border-[var(--dorado)]">
                                <pre><code>public double calcularBonificacion() {
    return calcularSueldoBasico() * 0.20;
}</code></pre>
                            </div>
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                <span class="text-[10px] text-[var(--dorado)] tracking-wider mb-1 uppercase font-bold">🧮 MODELO // NEGOCIO</span>
                                <h5 class="text-white font-bold mb-2 text-sm">Método: calcularBonificacion()</h5>
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">única tarea</span> de obtener la bonificación equivalente al **20%** sobre el sueldo básico calculado.
                                </p>
                            </div>
                        </div>
    ...
    return calcularSueldoBasico() 
            + calcularBonificacion();
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Determina el ingreso bruto total sumando el sueldo básico y la bonificación con <span class="text-[var(--dorado)]">responsabilidad exclusiva</span>.
                                </p>
                            </div>
                        </div>
    ...
    return calcularSueldoBruto() * 0.10;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Se encarga <span class="text-[var(--dorado)]">únicamente</span> de calcular las deducciones correspondientes al **10%** aplicadas sobre el sueldo bruto.
                                </p>
                            </div>
                        </div>
    ...
    return calcularSueldoBruto() 
            - calcularDescuento();
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Calcula con <span class="text-[var(--dorado)]">responsabilidad única</span> el importe líquido a percibir restando los descuentos al sueldo bruto.
                                </p>
                            </div>
                        </div>
