...
<html lang="es">
    <head>
        ...
        <title>S2E6 - Cálculo de Sueldos y Retenciones</title>
    ...
    <body class="min-h-screen flex flex-col p-4 md:p-6 justify-between">
        ...
        <header class="w-full max-w-[900px] mx-auto flex items-center justify-between py-5 px-6 bg-[#0d0d0d] border border-[#1c1c1c] rounded-t-lg">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-[var(--dorado)] tracking-widest font-mono uppercase">Semana 2 - Ejercicio 6</p>
                </div>
            </div>
        ...
        <main class="w-full max-w-[900px] mx-auto bg-[#0d0d0d] border-x border-[#1c1c1c] p-6 md:p-8 space-y-8">
            ...
            <div class="bg-[#111] p-4 rounded-lg border border-[#222]">
                <h2 class="text-xs font-mono text-[var(--dorado)] uppercase tracking-wider mb-2">📋 Enunciado del Ejercicio (Retenciones AFP y ESSALUD)</h2>
                <p class="text-sm text-gray-300 leading-relaxed">
                    Diseñe un algoritmo que calcule el <strong>sueldo bruto</strong> a partir de las horas trabajadas y la tarifa, aplique en paralelo un <strong>descuento por ESSALUD (9%)</strong> y otro por <strong>AFP (10%)</strong>, determine el <strong>descuento total</strong> y muestre el <strong>sueldo neto</strong> definitivo a abonar.
                </p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">

                <form action="${pageContext.request.contextPath}/S2E6Controller" method="POST" class="space-y-4">
                    <h3 class="text-sm font-mono text-white uppercase tracking-widest border-b border-[#222] pb-2">🎰 Ingreso de Tiempos</h3>
                    ...
                    <div>
                        <label for="tarifa" class="block text-xs font-mono text-gray-400 mb-1">Tarifa Horaria del Empleado (S/.):</label>
                ...
                <div class="bg-[#121212] border border-[#222] rounded-lg p-6 flex flex-col justify-between">
                    <div>
                        <h3 class="text-sm font-mono text-white uppercase tracking-widest border-b border-[#222] pb-2 mb-4">🏆 Boleta Salarial Completa</h3>
                        ...
                        <div class="space-y-3 font-mono">
                            ...
                            <div class="flex justify-between items-center py-2 border-b border-[#1c1c1c] text-emerald-400">
                                ...
                                <span class="text-sm font-bold">S/. ${sueldoBruto}</span>
                            </div>
                            <div class="flex justify-between items-center py-2 border-b border-[#1c1c1c] text-red-400">
                                ...
                                <span class="text-sm">- S/. ${descuentoEssalud}</span>
                            </div>
                            <div class="flex justify-between items-center py-2 border-b border-[#1c1c1c] text-red-400">
                                <span class="text-xs">📈 Retención AFP (10%):</span>
                                <span class="text-sm">- S/. ${descuentoAfp}</span>
                            </div>
                            <div class="flex justify-between items-center py-2 border-b border-[#1c1c1c] text-red-300">
                                <span class="text-xs font-bold">Retenciones Totales:</span>
                                <span class="text-sm font-bold">- S/. ${descuentoTotal}</span>
                            </div>
                            <div class="flex justify-between items-center py-2 pt-4">
                                <span class="text-xs text-[var(--dorado)] font-bold">Neto Efectivo a Pagar:</span>
                                <span class="text-lg font-bold text-[var(--dorado)]">S/. ${sueldoNeto}</span>
                            </div>
                        </div>
                        <% } else { %>
                        <p class="text-xs text-gray-500 font-mono italic text-center py-12">Por favor ingrese las horas laboradas y la tarifa correspondiente para desplegar los detalles de retención.</p>
                        <% }%>
                    </div>
                </div>
            </div>
                ...
                <details class="group bg-[#111] rounded-lg border border-[#222] transition-all duration-300 open:border-[var(--dorado)]">
                    <summary class="flex justify-between items-center p-4 cursor-pointer select-none hover:bg-[#161616] transition-colors rounded-lg">
                        <span class="text-xs font-mono text-[var(--dorado)] uppercase tracking-widest flex items-center gap-2">
                            <span>📖</span> MANUAL DE USO Y EXPLICACIÓN DE MÉTODOS (S2E6 - MVC)
                        </span>
    ...
    request.setAttribute("descuentoEssalud", 
        modelo.calcularDescuentoEssalud()
    );
    request.setAttribute("descuentoAfp", 
        ...
        modelo.calcularSueldoNeto()
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Encargado <span class="text-[var(--dorado)]">únicamente</span> de publicar en el Request Scope los valores del cálculo salarial: sueldo bruto, deducción ESSALUD, deducción AFP, retenciones totales y sueldo neto.
                                </p>
                            </div>
                        </div>
    ...
    request.getRequestDispatcher(
        "/html/semana02/S2E6.jsp"
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">función exclusiva</span> de transferir el control de la petición hacia la plantilla JSP correspondiente al Ejercicio 6 de la Semana 2.
                                </p>
                            </div>
                        </div>
    ...
    return this.horasTrabajadas * this.tarifaHoraria;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Calcula con <span class="text-[var(--dorado)]">responsabilidad única</span> la remuneración bruta multiplicando las horas efectivamente laboradas por la tarifa fijada por hora.
                                </p>
                            </div>
                        </div>
    ...
    return calcularSueldoBruto() * 0.09;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">única tarea</span> de obtener el aporte de seguro de salud retribuible a ESSALUD, equivalente al **9%** del sueldo bruto.
                                </p>
                            </div>
                        </div>
    ...
    return calcularSueldoBruto() * 0.10;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Calcula con <span class="text-[var(--dorado)]">responsabilidad exclusiva</span> la retención para el fondo previsional privado (AFP) aplicando el **10%** sobre el sueldo bruto.
                                </p>
                            </div>
                        </div>
    ...
    return calcularDescuentoEssalud() 
            + calcularDescuentoAfp();
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Se encarga <span class="text-[var(--dorado)]">únicamente</span> de consolidar la deducción global acumulando los importes resultantes de ESSALUD y AFP.
                                </p>
                            </div>
                        </div>
    ...
    return calcularSueldoBruto() 
            - calcularDescuentoTotal();
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Determina el importe líquido final a desembolsar al trabajador restando las retenciones totales consolidadas al sueldo bruto.
                                </p>
                            </div>
                        </div>
