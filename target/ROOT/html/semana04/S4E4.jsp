...
<html lang="es">
                    ...
                    <details class="group bg-[#111] rounded-lg border border-[#222] transition-all duration-300 open:border-[var(--dorado)]">
                        ...
                        <div class="p-6 border-t border-[#222] space-y-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <!-- Tarjeta 1: Modelo - getNota3ConBonificacion -->
                                <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
                                    <div class="lg:col-span-5 bg-black p-3 rounded font-mono text-[10px] text-[var(--dorado)] overflow-x-auto border-l-2 border-[var(--dorado)]">
                                        <pre><code>public double getNota3ConBonificacion() {
    ...
    return Math.min(notaFinalPC3, 20.0);
                                    ...
                                    <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                        ...
                                        <h5 class="text-white font-bold mb-2 text-sm">Método: getNota3ConBonificacion()</h5>
                                        <p class="text-gray-400 leading-relaxed">
                                            Método con la <span class="text-[var(--dorado)]">única función</span> de evaluar si la tercera práctica cumple con la condición de ser mayor o igual a 10 para añadirle 2 puntos de bonificación (tope 20).
                                        </p>
                                    </div>
                                </div>

                                <!-- Tarjeta 2: Modelo - tieneBonificacion -->
                                <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
                                    <div class="lg:col-span-5 bg-black p-3 rounded font-mono text-[10px] text-[var(--dorado)] overflow-x-auto border-l-2 border-[var(--dorado)]">
                                        <pre><code>public boolean tieneBonificacion() {
    return nota3 >= 10;
}</code></pre>
                                    </div>
                                    <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                        <span class="text-[10px] text-[var(--dorado)] tracking-wider mb-1 uppercase font-bold">🧮 MODELO // NEGOCIO</span>
                                        <h5 class="text-white font-bold mb-2 text-sm">Método: tieneBonificacion()</h5>
                                        <p class="text-gray-400 leading-relaxed">
                                            Encargado <span class="text-[var(--dorado)]">únicamente</span> de retornar un estado booleano para que la vista renderice dinámicamente las etiquetas o alertas de beneficio otorgado.
                                        </p>
                                    </div>
                                </div>

                                <!-- Tarjeta 3: Modelo - calcularPromedioFinal -->
                                <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
                                    <div class="lg:col-span-5 bg-black p-3 rounded font-mono text-[10px] text-[var(--dorado)] overflow-x-auto border-l-2 border-[var(--dorado)]">
                                        <pre><code>public double calcularPromedioFinal() {
    ...
    return (nota1 + nota2 + pc3Final) / 3.0;
                                    ...
                                    <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                        <span class="text-[10px] text-[var(--dorado)] tracking-wider mb-1 uppercase font-bold">🧮 MODELO // NEGOCIO</span>
                                        <h5 class="text-white font-bold mb-2 text-sm">Método: calcularPromedioFinal()</h5>
                                        <p class="text-gray-400 leading-relaxed">
                                            Tiene la <span class="text-[var(--dorado)]">única responsabilidad</span> de promediar las tres calificaciones utilizando el valor actualizado de la PC3 tras pasar por el filtro de la bonificación.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
                                    <div class="lg:col-span-5 bg-black p-3 rounded font-mono text-[10px] text-sky-400 overflow-x-auto border-l-2 border-sky-500">
                                        <pre><code>request.setAttribute("nota3Original", 
    model.getNota3());
request.setAttribute("nota3Final", 
    model.getNota3ConBonificacion());
request.setAttribute("bonificado", 
    model.tieneBonificacion());
request.setAttribute("promedioFinal", 
    model.calcularPromedioFinal());</code></pre>
                                    </div>
                                    <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                        ...
                                        <p class="text-gray-400 leading-relaxed">
                                            Encargado <span class="text-[var(--dorado)]">únicamente</span> de empaquetar los datos evaluados en la petición HTTP para ser desplegados con sintaxis EL en el JSP.
                                        </p>
                                    </div>
                                </div>
