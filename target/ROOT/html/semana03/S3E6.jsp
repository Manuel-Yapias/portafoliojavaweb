...
<html lang="es">
    <head>
        ...
        <title>S3E6 - Retenciones y Aportaciones de Ley</title>
    ...
    <body class="min-h-screen flex flex-col p-4 md:p-6 justify-between">
        ...
        <header class="w-full max-w-[900px] mx-auto flex items-center justify-between py-5 px-6 bg-[#0d0d0d] border border-[#1c1c1c] rounded-t-lg">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-[var(--dorado)] tracking-widest font-mono uppercase">Semana 3 - Ejercicio 6</p>
                </div>
            </div>
        ...
        <main class="w-full max-w-[900px] mx-auto bg-[#0d0d0d] border-x border-[#1c1c1c] p-6 md:p-8 space-y-8">
            ...
            <div class="bg-[#111] p-4 rounded-lg border border-[#222]">
                <h2 class="text-xs font-mono text-[var(--dorado)] uppercase tracking-wider mb-2">📋 Enunciado del Ejercicio (Planilla con Descuentos de Ley)</h2>
                <p class="text-sm text-gray-300 leading-relaxed">
                    Diseñe un programa que determine el <strong>sueldo bruto</strong> a partir de horas laboradas y tarifa, calcule un descuento por <strong>ESSALUD del 9%</strong>, un descuento por <strong>AFP del 10%</strong>, la suma de <strong>descuento total</strong> y el <strong>sueldo neto</strong> final.
                </p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">

                <form action="${pageContext.request.contextPath}/S3E6Controller" method="POST" class="space-y-4">
                    <h3 class="text-sm font-mono text-white uppercase tracking-widest border-b border-[#222] pb-2">🎰 Datos del Colaborador</h3>

                    <div>
                        <label for="horas" class="block text-xs font-mono text-gray-400 mb-1">Total de Horas Laboradas:</label>
                    ...
                    <div>
                        <label for="tarifa" class="block text-xs font-mono text-gray-400 mb-1">Tarifa por Hora (S/.):</label>
                ...
                <div class="bg-[#121212] border border-[#222] rounded-lg p-6 flex flex-col justify-between">
                    <div>
                        <h3 class="text-sm font-mono text-white uppercase tracking-widest border-b border-[#222] pb-2 mb-4">🏆 Boleta Detallada</h3>
                        ...
                        <div class="space-y-3 font-mono">
                            <div class="flex justify-between items-center py-2 border-b border-[#1c1c1c]">
                                <span class="text-xs text-gray-400">Horas registradas:</span>
                                <span class="text-sm text-white">${horas} hrs</span>
                            </div>
                            <div class="flex justify-between items-center py-2 border-b border-[#1c1c1c]">
                                <span class="text-xs text-gray-400">Tarifa horaria:</span>
                            ...
                            <div class="flex justify-between items-center py-2 border-b border-[#1c1c1c] text-red-400">
                                <span class="text-xs">📉 Retención ESSALUD (9%):</span>
                                <span class="text-sm">- S/. ${essalud}</span>
                            </div>
                            <div class="flex justify-between items-center py-2 border-b border-[#1c1c1c] text-red-400">
                                <span class="text-xs">📉 Retención AFP (10%):</span>
                                <span class="text-sm">- S/. ${afp}</span>
                            </div>
                            <div class="flex justify-between items-center py-2 border-b border-[#1c1c1c] text-orange-400">
                                <span class="text-xs">Suma Descuentos Totales:</span>
                                <span class="text-sm">S/. ${descuentoTotal}</span>
                            </div>
                            <div class="flex justify-between items-center py-2 pt-4">
                                <span class="text-xs text-[var(--dorado)] font-bold">Líquido Pagado al Empleado:</span>
                                <span class="text-lg font-bold text-[var(--dorado)]">S/. ${sueldoNeto}</span>
                            </div>
                        </div>
                        <% } else { %>
                        <p class="text-xs text-gray-500 font-mono italic text-center py-12">Por favor ingrese las horas de jornada y tarifa para desplegar la liquidación de ley.</p>
                        <% }%>
                    </div>
                </div>
            </div>
                ...
                <details class="group bg-[#111] rounded-lg border border-[#222] transition-all duration-300 open:border-[var(--dorado)]">
                    <summary class="flex justify-between items-center p-4 cursor-pointer select-none hover:bg-[#161616] transition-colors rounded-lg">
                        <span class="text-xs font-mono text-[var(--dorado)] uppercase tracking-widest flex items-center gap-2">
                            <span>📖</span> MANUAL DE USO Y EXPLICACIÓN DE MÉTODOS (S3E6 - MVC)
                        </span>
    ...
    request.setAttribute("essalud", 
        modelo.calcularDescuentoEssalud()
    );
    request.setAttribute("afp", 
        modelo.calcularDescuentoAfp()
    );
        ...
        modelo.calcularSueldoNeto()
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Encargado <span class="text-[var(--dorado)]">únicamente</span> de adjuntar al Request Scope los valores del cálculo de nómina: sueldo bruto, descuento ESSALUD, descuento AFP, descuento total y sueldo neto.
                                </p>
                            </div>
                        </div>
    ...
    request.getRequestDispatcher(
        "/html/semana03/S3E6.jsp"
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">función exclusiva</span> de direccionar el flujo de atención hacia la interfaz gráfica JSP del Ejercicio 6 de la Semana 3.
                                </p>
                            </div>
                        </div>

                        <!-- Método 3: calcularSueldoBruto() -->
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
    ...
    return this.horasTrabajadas 
            * this.tarifaHoraria;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Calcula con <span class="text-[var(--dorado)]">responsabilidad única</span> el sueldo bruto multiplicando la cantidad de horas laboradas por la tarifa por hora.
                                </p>
                            </div>
                        </div>

                        <!-- Método 4: calcularDescuentoEssalud() -->
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
                            <div class="lg:col-span-5 bg-black p-3 rounded font-mono text-[10px] text-[var(--dorado)] overflow-x-auto border-l-2 border-[var(--dorado)]">
                                <pre><code>public double calcularDescuentoEssalud() {
    return calcularSueldoBruto() * 0.09;
}</code></pre>
                            </div>
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                <span class="text-[10px] text-[var(--dorado)] tracking-wider mb-1 uppercase font-bold">🧮 MODELO // NEGOCIO</span>
                                <h5 class="text-white font-bold mb-2 text-sm">Método: calcularDescuentoEssalud()</h5>
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">única tarea</span> de calcular la retención por seguro de salud ESSALUD correspondiente al **9%** del sueldo bruto.
                                </p>
                            </div>
                        </div>

                        <!-- Método 5: calcularDescuentoAfp() -->
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
                            <div class="lg:col-span-5 bg-black p-3 rounded font-mono text-[10px] text-[var(--dorado)] overflow-x-auto border-l-2 border-[var(--dorado)]">
                                <pre><code>public double calcularDescuentoAfp() {
    return calcularSueldoBruto() * 0.10;
}</code></pre>
                            </div>
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                <span class="text-[10px] text-[var(--dorado)] tracking-wider mb-1 uppercase font-bold">🧮 MODELO // NEGOCIO</span>
                                <h5 class="text-white font-bold mb-2 text-sm">Método: calcularDescuentoAfp()</h5>
                                <p class="text-gray-400 leading-relaxed">
                                    Se encarga <span class="text-[var(--dorado)]">únicamente</span> de obtener la deducción para el fondo de pensiones AFP equivalente al **10%** del sueldo bruto.
                                </p>
                            </div>
                        </div>
    ...
    return calcularDescuentoEssalud() 
            + calcularDescuentoAfp();
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Determina el descuento total acumulado sumando los importes de ESSALUD y AFP, respetando su <span class="text-[var(--dorado)]">responsabilidad exclusiva</span>.
                                </p>
                            </div>
                        </div>
    ...
    return calcularSueldoBruto() 
            - calcularDescuentoTotal();
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Calcula con <span class="text-[var(--dorado)]">responsabilidad única</span> el sueldo neto líquido restando el descuento total al sueldo bruto.
                                </p>
                            </div>
                        </div>
