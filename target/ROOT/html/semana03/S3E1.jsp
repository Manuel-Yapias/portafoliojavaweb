...
<html lang="es">
    <head>
        ...
        <title>S3E1 - Compra de Producto con Incentivo</title>
    ...
    <body class="min-h-screen flex flex-col p-4 md:p-6 justify-between">
        ...
        <header class="w-full max-w-[900px] mx-auto flex items-center justify-between py-5 px-6 bg-[#0d0d0d] border border-[#1c1c1c] rounded-t-lg">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-[var(--dorado)] tracking-widest font-mono uppercase">Semana 3 - Ejercicio 1</p>
                </div>
            </div>
        ...
        <main class="w-full max-w-[900px] mx-auto bg-[#0d0d0d] border-x border-[#1c1c1c] p-6 md:p-8 space-y-8">
            ...
            <div class="bg-[#111] p-4 rounded-lg border border-[#222]">
                <h2 class="text-xs font-mono text-[var(--dorado)] uppercase tracking-wider mb-2">📋 Enunciado del Ejercicio (Compra con Incentivo)</h2>
                <p class="text-sm text-gray-300 leading-relaxed">
                    Determine el <strong>importe de la compra</strong> aplicando un <strong>11% de descuento</strong>. Como incentivo adicional, calcule el obsequio de <strong>2 caramelos por cada unidad</strong> de producto adquirida.
                </p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">

                <form action="${pageContext.request.contextPath}/S3E1Controller" method="POST" class="space-y-4">
                    <h3 class="text-sm font-mono text-white uppercase tracking-widest border-b border-[#222] pb-2">🎰 Datos de la Adquisición</h3>
                ...
                <div class="bg-[#121212] border border-[#222] rounded-lg p-6 flex flex-col justify-between">
                    <div>
                        ...
                        <div class="space-y-3 font-mono">
                            ...
                            <div class="flex justify-between items-center py-2 border-b border-[#1c1c1c]">
                                <span class="text-xs text-gray-400">Cantidad Solicitada:</span>
                            ...
                            <div class="flex justify-between items-center py-2 border-b border-[#1c1c1c] text-amber-400">
                                <span class="text-xs">Importe de Compra:</span>
                            ...
                            <div class="flex justify-between items-center py-2 border-b border-[#1c1c1c] text-red-400">
                                <span class="text-xs">Descuento Especial (11%):</span>
                            ...
                            <div class="flex justify-between items-center py-2 border-b border-[#1c1c1c] text-emerald-400">
                                <span class="text-xs">Incentivo (Caramelos):</span>
                                <span class="text-sm font-bold">🍬 ${caramelos} unidades</span>
                            </div>
                        ...
                        <% } else { %>
                        <p class="text-xs text-gray-500 font-mono italic text-center py-12">Ingrese el precio y la cantidad para simular el cálculo de compra y obsequio de la Semana 3.</p>
                        <% }%>
                    </div>
                </div>
            </div>
                ...
                <details class="group bg-[#111] rounded-lg border border-[#222] transition-all duration-300 open:border-[var(--dorado)]">
                    <summary class="flex justify-between items-center p-4 cursor-pointer select-none hover:bg-[#161616] transition-colors rounded-lg">
                        <span class="text-xs font-mono text-[var(--dorado)] uppercase tracking-widest flex items-center gap-2">
                            <span>📖</span> MANUAL DE USO Y EXPLICACIÓN DE MÉTODOS (S3E1 - MVC)
                        </span>
        ...
        modelo.calcularCaramelosObsequio()
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Encargado <span class="text-[var(--dorado)]">únicamente</span> de publicar en el Request Scope los valores resultantes de la compra: importe bruto, descuento, total a pagar y caramelos de obsequio.
                                </p>
                            </div>
                        </div>
    ...
    request.getRequestDispatcher(
        "/html/semana03/S3E1.jsp"
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">función exclusiva</span> de redirigir el flujo de la petición hacia la vista JSP correspondiente al Ejercicio 1 de la Semana 3.
                                </p>
                            </div>
                        </div>
    ...
    return this.precioProducto * this.cantidadUnidades;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Calcula con <span class="text-[var(--dorado)]">responsabilidad única</span> el subtotal bruto de la transacción multiplicando el precio unitario del producto por las unidades adquiridas.
                                </p>
                            </div>
                        </div>
    ...
    return calcularImporteCompra() * 0.11;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">única tarea</span> de calcular la deducción promocional aplicando el **11%** sobre el importe total de la compra.
                                </p>
                            </div>
                        </div>
    ...
    return calcularImporteCompra() 
            - calcularDescuento();
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Determina la suma neta final a cancelar restando el importe de descuento al valor subtotal de la compra, manteniendo su <span class="text-[var(--dorado)]">responsabilidad exclusiva</span>.
                                </p>
                            </div>
                        </div>
    ...
    return this.cantidadUnidades * 2;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Se encarga <span class="text-[var(--dorado)]">únicamente</span> de determinar la bonificación otorgando **2 caramelos** por cada unidad comprada.
                                </p>
                            </div>
                        </div>
