...
<html lang="es">
        ...
        modelo.calcularImporteAPagar()
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Encargado <span class="text-[var(--dorado)]">únicamente</span> de publicar en el Request Scope los datos procesados de la compra: importe bruto, primer descuento, segundo descuento, descuento total y el neto a pagar.
                                </p>
                            </div>
                        </div>
    ...
    request.getRequestDispatcher(
        "/html/semana03/S3E2.jsp"
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">función exclusiva</span> de redireccionar la petición HTTP hacia la vista JSP del Ejercicio 2 de la Semana 3.
                                </p>
                            </div>
                        </div>
    ...
    return this.precioProducto * this.cantidadUnidades;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Calcula con <span class="text-[var(--dorado)]">responsabilidad única</span> el importe total bruto multiplicando el precio unitario del producto por las unidades adquiridas.
                                </p>
                            </div>
                        </div>
    ...
    return calcularImporteCompra() * 0.10;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">única tarea</span> de calcular la primera rebaja equivalente al **10%** sobre el importe inicial de la compra.
                                </p>
                            </div>
                        </div>
    ...
    return resto * 0.10;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Calcula con <span class="text-[var(--dorado)]">responsabilidad exclusiva</span> el segundo descuento correspondiente al **10%** aplicado sobre el remanente posterior al primer descuento.
                                </p>
                            </div>
                        </div>
    ...
    return calcularPrimerDescuento() 
            + calcularSegundoDescuento();
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Se encarga <span class="text-[var(--dorado)]">únicamente</span> de consolidar la deducción acumulada mediante la suma del primer y segundo descuento.
                                </p>
                            </div>
                        </div>

                        <!-- Método 7: calcularImporteAPagar() -->
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
                            <div class="lg:col-span-5 bg-black p-3 rounded font-mono text-[10px] text-[var(--dorado)] overflow-x-auto border-l-2 border-[var(--dorado)]">
    ...
    return calcularImporteCompra() 
            - calcularDescuentoTotal();
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Determina la cantidad neta a abonar deduciendo la suma de ambos descuentos al valor base de la compra.
                                </p>
                            </div>
                        </div>
