...
<html lang="es">
    <head>
        ...
        <title>S3E5 - Cálculos Salariales de Vendedores</title>
        ...
        <header class="w-full max-w-[900px] mx-auto flex items-center justify-between py-5 px-6 bg-[#0d0d0d] border border-[#1c1c1c] rounded-t-lg">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-[var(--dorado)] tracking-widest font-mono uppercase">Semana 3 - Ejercicio 5</p>
                </div>
            </div>
        ...
        <main class="w-full max-w-[900px] mx-auto bg-[#0d0d0d] border-x border-[#1c1c1c] p-6 md:p-8 space-y-8">
            ...
            <div class="bg-[#111] p-4 rounded-lg border border-[#222]">
                ...
                <p class="text-sm text-gray-300 leading-relaxed">
                    Diseñe un programa que calcule la planilla de un vendedor: <strong>sueldo básico fijo (S/. 300)</strong>, <strong>comisión del 9%</strong> sobre las ventas mensuales, <strong>sueldo bruto</strong>, un <strong>descuento único del 11%</strong> y el <strong>sueldo neto</strong> final.
                </p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">

                <form action="${pageContext.request.contextPath}/S3E5Controller" method="POST" class="space-y-4">
                    <h3 class="text-sm font-mono text-white uppercase tracking-widest border-b border-[#222] pb-2">🎰 Declarar Ventas del Mes</h3>

                    <div>
                        <label for="importeVendido" class="block text-xs font-mono text-gray-400 mb-1">Importe Total Vendido (S/.):</label>
                    ...
                    <div>
                        ...
                        <div class="space-y-3 font-mono">
                            ...
                            <div class="flex justify-between items-center py-2 border-b border-[#1c1c1c] text-red-400">
                                <span class="text-xs">📉 Descuento (11%):</span>
                        ...
                        <% } else { %>
                        <p class="text-xs text-gray-500 font-mono italic text-center py-12">Declare la venta mensual para obtener el reporte salarial completo.</p>
                        <% }%>
                    </div>
                </div>
            </div>
                ...
                <details class="group bg-[#111] rounded-lg border border-[#222] transition-all duration-300 open:border-[var(--dorado)]">
                    <summary class="flex justify-between items-center p-4 cursor-pointer select-none hover:bg-[#161616] transition-colors rounded-lg">
                        <span class="text-xs font-mono text-[var(--dorado)] uppercase tracking-widest flex items-center gap-2">
                            <span>📖</span> MANUAL DE USO Y EXPLICACIÓN DE MÉTODOS (S3E5 - MVC)
                        </span>
        ...
        modelo.calcularSueldoNeto()
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Encargado <span class="text-[var(--dorado)]">únicamente</span> de almacenar en el Request Scope los resultados del cálculo salarial: sueldo básico fijo, comisión, sueldo bruto, descuento y sueldo neto.
                                </p>
                            </div>
                        </div>
    ...
    request.getRequestDispatcher(
        "/html/semana03/S3E5.jsp"
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">función exclusiva</span> de transferir el flujo de control hacia la vista JSP del Ejercicio 5 de la Semana 3.
                                </p>
                            </div>
                        </div>

                        <!-- Método 3: calcularComision() -->
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
    ...
    return this.importeVendido * 0.09;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Calcula con <span class="text-[var(--dorado)]">responsabilidad única</span> la comisión ganada equivalente al **9%** sobre el total de ventas realizadas.
                                </p>
                            </div>
                        </div>

                        <!-- Método 4: calcularSueldoBruto() -->
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
                            <div class="lg:col-span-5 bg-black p-3 rounded font-mono text-[10px] text-[var(--dorado)] overflow-x-auto border-l-2 border-[var(--dorado)]">
    ...
    return SUELDO_BASICO 
            + calcularComision();
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">única tarea</span> de determinar el sueldo bruto sumando el sueldo básico fijo (S/. 300) y la comisión obtenida.
                                </p>
                            </div>
                        </div>

                        <!-- Método 5: calcularDescuento() -->
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
                            <div class="lg:col-span-5 bg-black p-3 rounded font-mono text-[10px] text-[var(--dorado)] overflow-x-auto border-l-2 border-[var(--dorado)]">
    ...
    return calcularSueldoBruto() * 0.11;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Se encarga <span class="text-[var(--dorado)]">únicamente</span> de obtener el monto de descuento aplicando la tasa del **11%** sobre el sueldo bruto.
                                </p>
                            </div>
                        </div>

                        <!-- Método 6: calcularSueldoNeto() -->
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-[#141414] p-4 rounded border border-zinc-800 hover:border-zinc-700 transition-all">
                            <div class="lg:col-span-5 bg-black p-3 rounded font-mono text-[10px] text-[var(--dorado)] overflow-x-auto border-l-2 border-[var(--dorado)]">
    ...
    return calcularSueldoBruto() 
            - calcularDescuento();
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Calcula con <span class="text-[var(--dorado)]">responsabilidad única</span> la remuneración neta final restando la deducción calculada al sueldo bruto.
                                </p>
                            </div>
                        </div>
