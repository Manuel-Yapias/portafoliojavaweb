...
<html lang="es">
        ...
        modelo.calcularSueldoNeto()
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Encargado <span class="text-[var(--dorado)]">únicamente</span> de publicar en el Request Scope los valores del cálculo salarial: sueldo básico, bonificación, sueldo bruto, descuento y sueldo neto.
                                </p>
                            </div>
                        </div>
    ...
    request.getRequestDispatcher(
        "/html/semana03/S3E3.jsp"
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">función exclusiva</span> de reenviar el flujo de atención a la vista JSP correspondiente al Ejercicio 3 de la Semana 3.
                                </p>
                            </div>
                        </div>
    ...
    return this.horasTrabajadas 
            * this.tarifaHoraria;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Calcula con <span class="text-[var(--dorado)]">responsabilidad única</span> el sueldo básico inicial multiplicando las horas trabajadas por la tarifa por hora.
                                </p>
                            </div>
                        </div>
    ...
    return calcularSueldoBasico() * 0.20;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Tiene la <span class="text-[var(--dorado)]">única tarea</span> de calcular el incentivo o bonificación equivalente al **20%** sobre el sueldo básico.
                                </p>
                            </div>
                        </div>
    ...
    return calcularSueldoBasico() 
            + calcularBonificacion();
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Determina el sueldo bruto acumulando el sueldo básico y la bonificación calculada, manteniendo su <span class="text-[var(--dorado)]">responsabilidad exclusiva</span>.
                                </p>
                            </div>
                        </div>
    ...
    return calcularSueldoBruto() * 0.10;
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Se encarga <span class="text-[var(--dorado)]">únicamente</span> de obtener las deducciones aplicando un **10%** sobre el sueldo bruto total.
                                </p>
                            </div>
                        </div>
    ...
    return calcularSueldoBruto() 
            - calcularDescuento();
                            ...
                            <div class="lg:col-span-7 flex flex-col justify-center text-xs font-mono">
                                ...
                                <p class="text-gray-400 leading-relaxed">
                                    Calcula con <span class="text-[var(--dorado)]">responsabilidad única</span> el importe neto final a pagar deduciendo las retenciones del sueldo bruto.
                                </p>
                            </div>
                        </div>
